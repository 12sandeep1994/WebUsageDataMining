...
<%@page import="com.constants.WebUsageConstantsIF"%><html>
<head>
...
<%
	AJAXResponse ajaxResponse=(AJAXResponse) request.getAttribute(WebUsageConstantsIF.Keys.OBJ);
...
<form action="<%=request.getContextPath()%>/review/doFeatureVector.do" method="post"  >


	<table>
		<tr>
			<td><input type="hidden" name="type" value="1" ></input></td>
			<td><input  type="submit" value="Feature Vector"/></td>
		</tr>
