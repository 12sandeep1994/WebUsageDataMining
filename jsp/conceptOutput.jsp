<%@page import="com.model.ConceptsSearch"%>
...
<body background="<%=request.getContextPath()%>/images/background.jpg">
	...
	<%
		List<ConceptsSearch> results = (List<ConceptsSearch>) ajaxResponse
						.getModel();
				...
				if (null == results || results.isEmpty()) {
					...
					for(ConceptsSearch conceptsSearch:results)
					{
					
						String concept=conceptsSearch.getConcept();
			%>
			
			<table>
			<tr>
			<td>
			<div class="concept"><font color="blue" size="15" >Concept is :<%=concept%></font></div>
			</td>
			</tr>
			
			</table>
			<%			
						List<SearchObj> searchResults=conceptsSearch.getSearchList();
						
						if(searchResults!=null && !searchResults.isEmpty())
						{
					for (SearchObj googleResult : searchResults) {
	%>
